...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "${BRAND_PLACEHOLDER} — Encontre profissionais perto de você" },
      {
        name: "description",
        content:
      ...
      { name: "author", content: "${BRAND_PLACEHOLDER}" },
      { property: "og:title", content: "${BRAND_PLACEHOLDER} — Encontre profissionais perto de você" },
      {
      ...
      { name: "twitter:title", content: "${BRAND_PLACEHOLDER} — Encontre profissionais perto de você" },
    ...
    links: [
      ...
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=Inter:wght@400;500;600;700&family=Manrope:wght@500;600;700;800&family=Caveat:wght@600;700&display=swap",
      },
...
function RootComponent() {
  ...
  useEffect(() => {
    // Lazy import to keep this out of SSR
