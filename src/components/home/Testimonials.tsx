    ...
    <section className="bg-card py-16 sm:py-20" aria-labelledby="depoimentos">
      <div className="container-page grid min-w-0 gap-8 lg:grid-cols-[minmax(0,1fr)_360px]">
        <div className="min-w-0">
          ...
          <div className="mt-8 flex w-full min-w-0 max-w-full snap-x snap-mandatory gap-5 overflow-x-auto pb-2 lg:grid lg:grid-cols-3 lg:overflow-visible">
            {testimonials.map((t) => (
              <figure
                key={t.name}
                className="flex w-[85%] max-w-[22rem] shrink-0 snap-start flex-col rounded-3xl border border-border bg-background p-6 shadow-card sm:w-96 lg:w-auto lg:max-w-none"
              >
