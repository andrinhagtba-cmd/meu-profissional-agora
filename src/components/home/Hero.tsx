  ...
  return (
    <section className="relative overflow-hidden" aria-label="Encontre o profissional certo">
      <div className="relative overflow-hidden bg-secondary">
        ...
        <div className="relative overflow-hidden md:hidden">
          <picture key={active.id}>
            ...
            <img
              ...
              width={1024}
              height={1536}
              className="h-[26rem] w-full scale-125 object-cover object-[72%_100%] transition-opacity duration-500"
              fetchPriority="high"
            />
          </picture>
          <div
        ...
        <div className="container-page relative -mt-10 pb-40 pt-0 md:mt-0 md:pb-56 md:pt-20">
